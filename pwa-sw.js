...
const OFFLINE_CACHE_FILES = [
     'https://androidantenado.tech/bp/blog/',
];

const NOT_FOUND_CACHE_FILES = [
    'https://androidantenado.tech/bp/',
];

const OFFLINE_PAGE = 'https://androidantenado.tech/bp/blog/';
const NOT_FOUND_PAGE = 'https://androidantenado.tech/bp/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://androidantenado.tech/bp//wp-admin/');
//    },
];
